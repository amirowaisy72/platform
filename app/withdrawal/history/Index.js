                ...
                <Table className="min-w-full">
                  <TableHeader>
                    <TableRow className="bg-gradient-to-r from-slate-50 to-blue-50 hover:from-slate-100 hover:to-blue-100 border-b-2 border-slate-200">
                      ...
                      <TableHead className="text-slate-500 text-xs font-mono px-2 sm:px-4 hidden lg:table-cell">
                        Transaction ID
                      </TableHead>
                      <TableHead className="text-slate-700 font-bold text-xs sm:text-sm px-2 sm:px-4 text-center">
                        Actions
                      </TableHead>
                    </TableRow>
                  </TableHeader>
                        ...
                        <TableCell className="px-2 sm:px-4 py-2 sm:py-3 text-center">
                          {item.hasWallet ? (
                            <button
                              ...
                              className="p-2 rounded-lg bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 transition-all duration-200 shadow-md hover:shadow-lg"
                              title="View Receipt"
                            >
