        ...
        <div className="max-w-7xl mx-auto space-y-8 sm:space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 sm:gap-8">
            {allVipLevels.map((vip, index) => {
              ...
              return (
                <Card
                  key={vip.level}
                  className={`group relative p-6 sm:p-8 text-center bg-gradient-to-br ${vip.bgColor} shadow-2xl border-2 ${
                    isCurrent ? vip.borderColor : "border-[#a3d65c]/20"
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="space-y-3 mb-6">
                      ...
                      <div className="flex items-center justify-between p-3 bg-[#2d3e2f]/50 rounded-xl border border-[#a3d65c]/20">
                        <span className="text-sm font-medium text-gray-300">Withdrawal Limit</span>
                        <span className="text-sm font-bold text-[#a3d65c]">{vip.withdrawalLimit}</span>
                      </div>
                    </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  ...
                  <tr className="border-b border-[#a3d65c]/10">
                    <td className="p-4 font-medium text-gray-300">Withdrawal Limit</td>
                    {allVipLevels.map((vip) => (
                      <td key={vip.level} className="text-center p-4 font-bold text-[#a3d65c]">
                        {vip.withdrawalLimit}
                      </td>
          ...
          <Card className="p-6 sm:p-8 text-center bg-gradient-to-r from-[#3a4d3c] to-[#2d3e2f] shadow-2xl border border-[#a3d65c]/20 rounded-3xl">
            <div className="text-white">
              ...
              <Button className="bg-[#a3d65c] text-[#2d3e2f] hover:bg-[#8bc34a] font-bold px-8 py-3 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
