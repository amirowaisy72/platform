        ...
        <div className="flex flex-col min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
            ...
            <main className="flex-1 overflow-auto p-4 md:p-6 pb-32 lg:pb-48">
                <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8">
                    ...
                    <Card className="p-6 sm:p-8 bg-white/70 backdrop-blur-sm shadow-2xl border border-white/20 rounded-3xl">
                        <div className="flex items-center gap-3 sm:gap-4 mb-6">
                            <div className="p-2 sm:p-3 rounded-2xl bg-gradient-to-r from-blue-500 to-cyan-600">
                                <LucideIcons.User className="h-5 w-5 sm:h-6 sm:w-6 text-white" />
                            </div>
                        ...
                        <div className="space-y-6">
                            {/* Username */}
                            <div className="p-4 sm:p-6 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl border border-blue-100">
                            ...
                            {/* Phone */}
                            <div className="p-4 sm:p-6 bg-gradient-to-r from-purple-50 to-violet-50 rounded-2xl border border-purple-100">
                                <div className="flex items-center justify-between mb-3">
                                    <Label className="text-slate-700 font-semibold flex items-center gap-2">
                            ...
                            {/* Join Date */}
                            <div className="p-4 sm:p-6 bg-gradient-to-r from-orange-50 to-red-50 rounded-2xl border border-orange-100">
                                <Label className="text-slate-700 font-semibold flex items-center gap-2 mb-3">
                                    <LucideIcons.Calendar className="h-4 w-4" />
                                    Member Since
                                </Label>
                                <p className="text-slate-800 font-medium">{formateDate(user?.createdAt)}</p>
                            </div>
                        </div>
                    </Card>
                    ...
                    <Card className="p-6 sm:p-8 bg-white/70 backdrop-blur-sm shadow-2xl border border-white/20 rounded-3xl">
                        <div className="flex items-center gap-3 sm:gap-4 mb-6">
                            <div className="p-2 sm:p-3 rounded-2xl bg-gradient-to-r from-red-500 to-pink-600">
                                <LucideIcons.Shield className="h-5 w-5 sm:h-6 sm:w-6 text-white" />
                            </div>
                            <h2 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent">
                                Security Settings
                            </h2>
                        ...
                        <div className="space-y-4">
                            {/* Login Password */}
                            <div className="p-4 sm:p-6 bg-gradient-to-r from-red-50 to-pink-50 rounded-2xl border border-red-100">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-slate-600 text-sm">Used for logging into the account</p>
                                    </div>

                                    <Dialog open={showPasswordDialog} onOpenChange={setShowPasswordDialog}>
                                        <DialogTrigger asChild>
                                            <Button className="bg-gradient-to-r from-red-500 to-pink-600 text-white font-bold px-4 py-2 rounded-xl">
                                        ...
                                        <DialogContent className="sm:max-w-[425px] bg-white/95 backdrop-blur-xl">
                                            ...
                                            <div className="space-y-4 py-4">
                                                ...
                                                <Button
                                                    ...
                                                    className="w-full bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-bold py-3 rounded-xl disabled:opacity-50 disabled:cursor-not-allowed"
                                                >
                                                    {isUpdatingPassword ? (
                            ...
                            <div className="p-4 sm:p-6 bg-gradient-to-r from-yellow-50 to-orange-50 rounded-2xl border border-yellow-100">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <Label className="text-slate-700 font-semibold flex items-center gap-2 mb-2">
                                        ...
                                        <p className="text-slate-600 text-sm">Used for withdrawals and sensitive operations</p>
                                    </div>

                                    <Dialog open={showTransactionPasswordDialog} onOpenChange={setShowTransactionPasswordDialog}>
                                        <DialogTrigger asChild>
                                            <Button className="bg-gradient-to-r from-yellow-500 to-orange-600 text-white font-bold px-4 py-2 rounded-xl">
                                                <LucideIcons.Key className="h-4 w-4 mr-2" />
                                                Change
                                            </Button>
                                        </DialogTrigger>
                                        ...
                                        <DialogContent className="sm:max-w-[425px] bg-white/95 backdrop-blur-xl">
                                            <DialogHeader>
                                                <DialogTitle>Change Transaction Password</DialogTitle>
                                            </DialogHeader>
